    ...
    switch (type) {
        ...
        case CONNECTION_DISCONNECTED: {
            ...
            if (!conference) {
                ...
                EVENT_EMITTER && EVENT_EMITTER.remove()
        ...
        case SET_VIDEO_MUTED:
            sendEvent( store, VIDEO_MUTED, { muted: action.muted.toString() });
            break;
        case SET_AUDIO_MUTED: 
            sendEvent(store, AUDIO_MUTED, { muted: action.muted ? '1' : '0' });
            break;
    }
